...
- Генерация названия, жанров, года, рейтинга, режиссёра, актёров и синопсиса через Gemini или OpenAI.
...
- `GEMINI_TEXT_MODEL` — основная модель для сценарной генерации фильма, если задан `GEMINI_API_KEY`.
- `OPENAI_TEXT_MODEL` — fallback-модель для сценарной генерации фильма, если Gemini key не задан.
